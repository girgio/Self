...
_x = xstart*(global.w_risoluzione/camera_get_view_width(view_camera[0]))+(0.25*0.20*global.w_risoluzione)
_x_text = xstart*(global.w_risoluzione/camera_get_view_width(view_camera[0]))+(0.25*0.50*global.w_risoluzione) 
_w = 0.25*global.w_risoluzione*0.6
_h = 0.15*(global.h_risoluzione*(1/9))
_y = ystart*(global.h_risoluzione/camera_get_view_height(view_camera[0]))-_h*2 - 0.15*(global.h_risoluzione*(1/9))
_y_text = ystart*(global.h_risoluzione/camera_get_view_height(view_camera[0]))-_h*1.5- 0.15*(global.h_risoluzione*(1/9))
